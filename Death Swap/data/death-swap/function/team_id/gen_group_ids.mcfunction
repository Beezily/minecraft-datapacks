...
# Reset all players team color scores
execute as @a run scoreboard players reset @s Red
execute as @a run scoreboard players reset @s Yellow
execute as @a run scoreboard players reset @s Blue
execute as @a run scoreboard players reset @s Green
execute as @a run scoreboard players reset @s Aqua
execute as @a run scoreboard players reset @s Purple
...
# Generate team ID's
execute as @a[team=Red,gamemode=survival,sort=random] run function death-swap:team_id/join_red
execute as @a[team=Yellow,gamemode=survival,sort=random] run function death-swap:team_id/join_yellow
execute as @a[team=Blue,gamemode=survival,sort=random] run function death-swap:team_id/join_blue
execute as @a[team=Green,gamemode=survival,sort=random] run function death-swap:team_id/join_green
execute as @a[team=Aqua,gamemode=survival,sort=random] run function death-swap:team_id/join_aqua
execute as @a[team=Purple,gamemode=survival,sort=random] run function death-swap:team_id/join_purple
...
# REMOVED: Added the player count update to the trim function
...
execute as @a[gamemode=survival,team=,sort=random] at @s run function death-swap:team_id/gen_solo_join

## REMOVED: Unecessary? We can just assign unique team id during gen_solo for solo players?
...
## > GLITCH < ? No team score = no way to determine who to swap? Why remove?
...
# We anchor the marker summon random pick at some @r in case it runs in an unloaded chunk
...
# Start with a max group size team (I guess purple wins if all solo)
...
# REMOVED: We never joined a team
...
# Reset team scores again (so doesn't make players join a random team)
execute as @a run scoreboard players reset @s Red
execute as @a run scoreboard players reset @s Yellow
execute as @a run scoreboard players reset @s Blue
execute as @a run scoreboard players reset @s Green
