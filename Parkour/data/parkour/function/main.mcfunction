...
# Water kill
execute if score %water_kill parkour matches 1 as @a[gamemode=!spectator] at @s if block ~ ~ ~ water run kill @s
execute if score %water_kill parkour matches 1 as @a[gamemode=!spectator] at @s if block ~ ~1 ~ water run kill @s

# Lava kill
execute if score %lava_kill parkour matches 1 as @a[gamemode=!spectator] at @s if block ~ ~ ~ lava run kill @s
execute if score %lava_kill parkour matches 1 as @a[gamemode=!spectator] at @s if block ~ ~1 ~ lava run kill @s
...
execute unless score %lava_kill parkour matches 1 as @a[team=Red] unless items entity @s armor.feet *[custom_data~{parkourRed:1b}] run item replace entity @s armor.feet with leather_boots[dyed_color=16733525,enchantments={"binding_curse":1},tooltip_display={hidden_components:["enchantments"]},enchantment_glint_override=false,custom_name={"color":"#FF5555","italic":false,"text":"Red Team"},custom_data={parkourRed:1b},unbreakable={}] 1
execute unless score %lava_kill parkour matches 1 as @a[team=Yellow] unless items entity @s armor.feet *[custom_data~{parkourYellow:1b}] run item replace entity @s armor.feet with leather_boots[dyed_color=16777045,enchantments={"binding_curse":1},tooltip_display={hidden_components:["enchantments"]},enchantment_glint_override=false,custom_name={"color":"#FFFF55","italic":false,"text":"Yellow Team"},custom_data={parkourYellow:1b},unbreakable={}] 1
execute unless score %lava_kill parkour matches 1 as @a[team=Blue] unless items entity @s armor.feet *[custom_data~{parkourBlue:1b}] run item replace entity @s armor.feet with leather_boots[dyed_color=5592575,enchantments={"binding_curse":1},tooltip_display={hidden_components:["enchantments"]},enchantment_glint_override=false,custom_name={"color":"#5555FF","italic":false,"text":"Blue Team"},custom_data={parkourBlue:1b},unbreakable={}] 1
execute unless score %lava_kill parkour matches 1 as @a[team=Green] unless items entity @s armor.feet *[custom_data~{parkourGreen:1b}] run item replace entity @s armor.feet with leather_boots[dyed_color=5635925,enchantments={"binding_curse":1},tooltip_display={hidden_components:["enchantments"]},enchantment_glint_override=false,custom_name={"color":"#55FF55","italic":false,"text":"Green Team"},custom_data={parkourGreen:1b},unbreakable={}] 1
execute unless score %lava_kill parkour matches 1 as @a[team=Aqua] unless items entity @s armor.feet *[custom_data~{parkourAqua:1b}] run item replace entity @s armor.feet with leather_boots[dyed_color=5636095,enchantments={"binding_curse":1},tooltip_display={hidden_components:["enchantments"]},enchantment_glint_override=false,custom_name={"color":"#55FFFF","italic":false,"text":"Aqua Team"},custom_data={parkourAqua:1b},unbreakable={}] 1
execute unless score %lava_kill parkour matches 1 as @a[team=Purple] unless items entity @s armor.feet *[custom_data~{parkourPurple:1b}] run item replace entity @s armor.feet with leather_boots[dyed_color=16733695,enchantments={"binding_curse":1},tooltip_display={hidden_components:["enchantments"]},enchantment_glint_override=false,custom_name={"color":"#FF55FF","italic":false,"text":"Purple Team"},custom_data={parkourPurple:1b},unbreakable={}] 1
execute unless score %lava_kill parkour matches 1 as @a[team=] unless items entity @s armor.feet *[custom_data~{parkourSolo:1b}] run item replace entity @s armor.feet with leather_boots[dyed_color=16777215,enchantments={"binding_curse":1},tooltip_display={hidden_components:["enchantments"]},enchantment_glint_override=false,custom_name={"color":"#FFFFFF","italic":false,"text":"Solo Team"},custom_data={parkourSolo:1b},unbreakable={}] 1
execute if score %lava_kill parkour matches 1 as @a[team=Red] unless items entity @s armor.feet *[custom_data~{parkourRed:1b}] run item replace entity @s armor.feet with leather_boots[dyed_color=16733525,enchantments={"binding_curse":1,"fire_protection":2},tooltip_display={hidden_components:["enchantments"]},enchantment_glint_override=false,custom_name={"color":"#FF5555","italic":false,"text":"Red Team"},custom_data={parkourRed:1b},unbreakable={}] 1
execute if score %lava_kill parkour matches 1 as @a[team=Yellow] unless items entity @s armor.feet *[custom_data~{parkourYellow:1b}] run item replace entity @s armor.feet with leather_boots[dyed_color=16777045,enchantments={"binding_curse":1,"fire_protection":2},tooltip_display={hidden_components:["enchantments"]},enchantment_glint_override=false,custom_name={"color":"#FFFF55","italic":false,"text":"Yellow Team"},custom_data={parkourYellow:1b},unbreakable={}] 1
execute if score %lava_kill parkour matches 1 as @a[team=Blue] unless items entity @s armor.feet *[custom_data~{parkourBlue:1b}] run item replace entity @s armor.feet with leather_boots[dyed_color=5592575,enchantments={"binding_curse":1,"fire_protection":2},tooltip_display={hidden_components:["enchantments"]},enchantment_glint_override=false,custom_name={"color":"#5555FF","italic":false,"text":"Blue Team"},custom_data={parkourBlue:1b},unbreakable={}] 1
execute if score %lava_kill parkour matches 1 as @a[team=Green] unless items entity @s armor.feet *[custom_data~{parkourGreen:1b}] run item replace entity @s armor.feet with leather_boots[dyed_color=5635925,enchantments={"binding_curse":1,"fire_protection":2},tooltip_display={hidden_components:["enchantments"]},enchantment_glint_override=false,custom_name={"color":"#55FF55","italic":false,"text":"Green Team"},custom_data={parkourGreen:1b},unbreakable={}] 1
execute if score %lava_kill parkour matches 1 as @a[team=Aqua] unless items entity @s armor.feet *[custom_data~{parkourAqua:1b}] run item replace entity @s armor.feet with leather_boots[dyed_color=5636095,enchantments={"binding_curse":1,"fire_protection":2},tooltip_display={hidden_components:["enchantments"]},enchantment_glint_override=false,custom_name={"color":"#55FFFF","italic":false,"text":"Aqua Team"},custom_data={parkourAqua:1b},unbreakable={}] 1
execute if score %lava_kill parkour matches 1 as @a[team=Purple] unless items entity @s armor.feet *[custom_data~{parkourPurple:1b}] run item replace entity @s armor.feet with leather_boots[dyed_color=16733695,enchantments={"binding_curse":1,"fire_protection":2},tooltip_display={hidden_components:["enchantments"]},enchantment_glint_override=false,custom_name={"color":"#FF55FF","italic":false,"text":"Purple Team"},custom_data={parkourPurple:1b},unbreakable={}] 1
execute if score %lava_kill parkour matches 1 as @a[team=] unless items entity @s armor.feet *[custom_data~{parkourSolo:1b}] run item replace entity @s armor.feet with leather_boots[dyed_color=16777215,enchantments={"binding_curse":1,"fire_protection":2},tooltip_display={hidden_components:["enchantments"]},enchantment_glint_override=false,custom_name={"color":"#FFFFFF","italic":false,"text":"Solo Team"},custom_data={parkourSolo:1b},unbreakable={}] 1
