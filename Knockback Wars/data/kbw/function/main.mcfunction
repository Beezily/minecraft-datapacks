...
execute as @a[team=Reaper] unless items entity @s armor.chest minecraft:leather_chestplate[custom_data~{reaper:1b},dyed_color=0] run item replace entity @s armor.chest with minecraft:leather_chestplate[custom_name={text:"Reaper's Robe",color:'black',italic:false},lore=[{text:"An ancient, ragged cloak. It has"},{text:'weathered a millennium at your side.'}],dyed_color=0,unbreakable={},tooltip_display={hidden_components:['minecraft:enchantments','minecraft:unbreakable']},attribute_modifiers=[{id:'movement_speed',type:'minecraft:movement_speed',amount:0.05,operation:'add_multiplied_base',slot:'head'}],custom_data={reaper:1b},enchantments={binding_curse:1},enchantment_glint_override=false]
...
execute as @a[team=Archer,tag=inGame,nbt={active_effects:[{id:"minecraft:weakness"}]}] if items entity @s container.* minecraft:arrow run clear @s minecraft:arrow
execute as @a[team=Archer,tag=inGame,nbt={active_effects:[{id:"minecraft:weakness"}]}] if items entity @s weapon.* minecraft:arrow run clear @s minecraft:arrow
execute as @a[team=Archer,tag=inGame,nbt=!{active_effects:[{id:"minecraft:weakness"}]}] unless items entity @s container.* minecraft:arrow unless items entity @s weapon.* minecraft:arrow unless items entity @s player.cursor minecraft:arrow run give @s minecraft:arrow[custom_name={text:"Arrow",color:"aqua",italic:false}] 1
execute as @a[team=,tag=inGame,nbt={active_effects:[{id:"minecraft:weakness"}]}] if items entity @s container.* minecraft:arrow run clear @s minecraft:arrow
execute as @a[team=,tag=inGame,nbt={active_effects:[{id:"minecraft:weakness"}]}] if items entity @s weapon.* minecraft:arrow run clear @s minecraft:arrow
execute as @a[team=,tag=inGame,nbt=!{active_effects:[{id:"minecraft:weakness"}]}] unless items entity @s container.* minecraft:arrow unless items entity @s weapon.* minecraft:arrow unless items entity @s player.cursor minecraft:arrow run give @s minecraft:arrow 1

# Ghost when has weakness (stunned)
execute as @a[team=Ghost,tag=inGame,nbt={active_effects:[{id:"minecraft:weakness"}]}] if items entity @s container.* *[custom_data~{ghost:1b}] run clear @s minecraft:carved_pumpkin[custom_data~{ghost:1b}]
execute as @a[team=Ghost,tag=inGame,nbt=!{active_effects:[{id:"minecraft:weakness"}]}] unless items entity @s container.* *[custom_data~{ghost:1b}] unless items entity @s weapon.* *[custom_data~{ghost:1b}] unless items entity @s player.cursor *[custom_data~{ghost:1b}] unless items entity @s weapon.mainhand * run item replace entity @s weapon.mainhand with minecraft:carved_pumpkin[custom_name={text:"Scary Face",color:"gray",italic:false},lore=[{text:"Hold your ground and"},{text:"make your opponents"},{text:"jump with fright!"}],enchantments={knockback:4,piercing:10,sharpness:5},attribute_modifiers=[{id:"kbw:scaryface_mainhand_slow",type:"minecraft:movement_speed",amount:-2.0d,operation:"add_multiplied_total",slot:"any"}],piercing_weapon={deals_knockback:true,hit_sound:"entity.rabbit.attack",sound:"entity.armadillo.brush"},swing_animation={duration:10,type:"stab"},attack_range={min_reach:0.0,max_reach:3.0,min_creative_reach:0.0,max_creative_reach:5.0,hitbox_margin:0.5},custom_data={ghost:1b}] 1
execute as @a[team=Ghost,tag=inGame,nbt=!{active_effects:[{id:"minecraft:weakness"}]}] unless items entity @s container.* *[custom_data~{ghost:1b}] unless items entity @s weapon.* *[custom_data~{ghost:1b}] unless items entity @s player.cursor *[custom_data~{ghost:1b}] run give @s minecraft:carved_pumpkin[custom_name={text:"Scary Face",color:"gray",italic:false},lore=[{text:"Hold your ground and"},{text:"make your opponents"},{text:"jump with fright!"}],enchantments={knockback:4,piercing:10,sharpness:5},attribute_modifiers=[{id:"kbw:scaryface_mainhand_slow",type:"minecraft:movement_speed",amount:-2.0d,operation:"add_multiplied_total",slot:"any"}],piercing_weapon={deals_knockback:true,hit_sound:"entity.rabbit.attack",sound:"entity.armadillo.brush"},swing_animation={duration:10,type:"stab"},attack_range={min_reach:0.0,max_reach:3.0,min_creative_reach:0.0,max_creative_reach:5.0,hitbox_margin:0.5},custom_data={ghost:1b}] 1
...
execute as @a[team=Duelist,scores={blocked=0..}] at @s as @e[distance=..5,type=!#impact_projectiles,type=!armor_stand,type=!ender_pearl,type=!minecraft:splash_potion,type=!minecraft:lingering_potion] unless score @s blocked matches 0.. run effect give @s minecraft:weakness 2 100 true
