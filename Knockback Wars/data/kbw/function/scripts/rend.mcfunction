...
execute if score @s rend matches 0 at @s run effect give @e[tag=hit] minecraft:darkness 9 1 true
execute if score @s rend matches 0 at @s run effect give @e[tag=hit] minecraft:hunger 12 255 true
