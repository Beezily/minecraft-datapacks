...
# RED
execute if entity @s[team=Red] if score @s Red matches 0 unless score %next Red matches 5.. run function sg:team_id/join_red
...
# YELLOW
execute if entity @s[team=Yellow] if score @s Yellow matches 0 unless score %next Yellow matches 5.. run function sg:team_id/join_yellow
...
# BLUE
execute if entity @s[team=Blue] if score @s Blue matches 0 unless score %next Blue matches 5.. run function sg:team_id/join_blue
...
# GREEN
execute if entity @s[team=Green] if score @s Green matches 0 unless score %next Green matches 5.. run function sg:team_id/join_green
...
# AQUA
execute if entity @s[team=Aqua] if score @s Aqua matches 0 unless score %next Aqua matches 5.. run function sg:team_id/join_aqua
...
# PURPLE
execute if entity @s[team=Purple] if score @s Purple matches 0 unless score %next Purple matches 5.. run function sg:team_id/join_purple
