...
execute positioned ^ ^ ^0.4 if block ^ ^ ^ ender_chest align xyz positioned ~0.5 ~0.5 ~0.5 run function sg:scripts/create_ender_loot
scoreboard players add @s new_chest 1
execute if score @s new_chest matches 1..12 positioned ^ ^ ^0.4 run function sg:scripts/find_ender