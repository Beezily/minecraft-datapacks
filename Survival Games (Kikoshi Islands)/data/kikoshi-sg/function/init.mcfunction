tellraw @a [{"text":"reload - "},{"text":"Survival Games (Kikoshi Islands)","color":"light_purple","bold":true},{"text":" - ","color":"white","bold":false},{"text":"by Beezily","color":"light_purple"}]
...
scoreboard players set %countdown sg 0
...
scoreboard players set %pvp_announced sg 0

# Bossbar
bossbar remove kikoshi-sg:timer
bossbar add kikoshi-sg:timer {"text":"Survival Games","color":"#ff8c00","bold":true}
bossbar set kikoshi-sg:timer color red
bossbar set kikoshi-sg:timer max 24000
bossbar set kikoshi-sg:timer value 24000
bossbar set kikoshi-sg:timer players @a
bossbar set kikoshi-sg:timer visible false
